...
const initialShapes = [
  ...
  {key: 'rect5', type: 'rectangle', x: 900, y: 100, rotation: 0, width: 325, height: 200, z: 9, backgroundColor: '#e6f5c9', backgroundImage: 'url("data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAoAAAAKCAYAAACNMs+9AAAAGElEQVQYlWNgYGCQwoKxgqGgcJA5h3yFAAs8BRWVSwooAAAAAElFTkSuQmCC")'},
]
...
const pad = 10
const gridPitch = 0.1
const snapEngageDistance = 12
const snapReleaseDistance = 3 * snapEngageDistance // hysteresis: make it harder to break bond
