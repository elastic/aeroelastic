 ...
 *
 */
const transpose = ([a, d, g, b, e, h, c, f, i]) =>
  ([a, b, c, d, e, f, g, h, i])
...
// (eg. pre-transpose)
const translate = (x, y) => transpose([
  1, 0, x,
  0, 1, y,
  0, 0, 1
])

const scale = (x, y) => transpose([
  x, 0, 0,
  0, y, 0,
  0, 0, 1
])
...
module.exports = {
  ORIGIN, NULLVECTOR, NULLMATRIX, UNITMATRIX, transpose, translate, shear, scale,
  multiply, mvMultiply, normalize, applyTransforms, reduceTransforms,
  add, subtract, dotProduct, componentProduct
}